    ...
    <div class="max-w-md w-full space-y-8">
        <div>
            ...
            <p class="mt-2 text-center text-sm text-gray-600">
                Atau
                <a href="{{ route('register') }}" class="font-medium text-perpustakaan-blue hover:text-perpustakaan-blue/80">
                    daftar akun baru
                </a>
            </p>
        </div>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    <input id="remember-me" name="remember" type="checkbox"
                           class="h-4 w-4 text-perpustakaan-blue focus:ring-perpustakaan-blue border-gray-300 rounded">
                ...
                <div class="text-sm">
                    <a href="#" class="font-medium text-perpustakaan-blue hover:text-perpustakaan-blue/80">
                        Lupa kata sandi?
                    </a>
                </div>
            </div>
